 ...
 * @author hubeini
 *因为要加入查看属性的功能
 *将原先file和folder的create resetname delete open
 *抽象成了一个模版的父类
 *具体接口实现在子类中完成
 *
 *
...
public abstract class  MyDocument implements I_DocumentFactory{	
	...
	String whoAmI;				        //文件或文件夹
	String fatherAddress;               //文件夹所在地址
	String name;
	String createTime;
	String visitTime;
	String modifiTime;
